...
/**
 * Bulk importer that takes lines from a NCSA common logs and can produce a row for each entry
 * in the log file.  This is the basic log file format used by the Apache HTTP server.  This bulk
 * importer uses {@link org.kiji.mapreduce.lib.util.CommonLogParser} for parsing lines into
 * fields.
 *
 * <h2>Creating a bulk import job for NCSA Common logs:</h2>
 * <p>
